...
ROOT::VecOps::RVec<float> ReconstructedParticle::acolinearity(ROOT::VecOps::RVec<edm4hep::ReconstructedParticleData> in){
  ROOT::VecOps::RVec<float> result;
...
ROOT::VecOps::RVec<float> ReconstructedParticle::acoplanarity(ROOT::VecOps::RVec<edm4hep::ReconstructedParticleData> in){
  ROOT::VecOps::RVec<float> result;
  if(in.size() != 2) return result;
...
ReconstructedParticle::momentum_scale::momentum_scale(float arg_scaleunc) : scaleunc(arg_scaleunc) {};
ROOT::VecOps::RVec<edm4hep::ReconstructedParticleData>  ReconstructedParticle::momentum_scale::operator() (ROOT::VecOps::RVec<edm4hep::ReconstructedParticleData> in) {
  ROOT::VecOps::RVec<edm4hep::ReconstructedParticleData> result;
  result.reserve(in.size());
  for (size_t i = 0; i < in.size(); ++i) {
    auto & p = in[i];
...
ReconstructedParticle::sel_type::sel_type( int arg_pdg, bool arg_chargeconjugate) : m_pdg(arg_pdg), m_chargeconjugate( arg_chargeconjugate )  {};

ROOT::VecOps::RVec<edm4hep::ReconstructedParticleData>  ReconstructedParticle::sel_type::operator() (ROOT::VecOps::RVec<edm4hep::ReconstructedParticleData> in) {
  ROOT::VecOps::RVec<edm4hep::ReconstructedParticleData> result;
  result.reserve(in.size());
  for (size_t i = 0; i < in.size(); ++i) {
    auto & p = in[i];
...
ROOT::VecOps::RVec<float> ReconstructedParticle::Isolation( ROOT::VecOps::RVec<edm4hep::ReconstructedParticleData> particles, ROOT::VecOps::RVec<edm4hep::ReconstructedParticleData> in ) {
...
ReconstructedParticle::sel_isol::sel_isol( float arg_isocut ) : m_isocut (arg_isocut) {};
ROOT::VecOps::RVec<edm4hep::ReconstructedParticleData> ReconstructedParticle::sel_isol::operator() (  ROOT::VecOps::RVec<edm4hep::ReconstructedParticleData> particles, ROOT::VecOps::RVec<float> var ) { 
...
ReconstructedParticle::BoostAngle::BoostAngle( float arg_angle ) : m_angle ( arg_angle ) {};
ROOT::VecOps::RVec<edm4hep::ReconstructedParticleData> ReconstructedParticle::BoostAngle::operator() ( ROOT::VecOps::RVec<edm4hep::ReconstructedParticleData> in ) {
  ROOT::VecOps::RVec<edm4hep::ReconstructedParticleData> result;
...
ROOT::VecOps::RVec<edm4hep::ReconstructedParticleData> ReconstructedParticle::Merger( ROOT::VecOps::RVec<edm4hep::ReconstructedParticleData> in ) {
